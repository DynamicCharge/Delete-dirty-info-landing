...
$(document).ready(function(){
	$('.ac-trigger').on('click', function(){
		...
		if(!$(this).hasClass('_active')){
			...
			$(this).parent().find('.ac-content').addClass('_active');
			$(this).parent().find('.ac-content').slideDown(300);
		}else {
			$(this).removeClass('_active');
			$(this).parent().find('.ac-content').removeClass('_active');
			$(this).parent().find('.ac-content').slideUp(300);
		}
	});
});